      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Treasury</h1>
              <p className="text-slate-400 text-sm mt-1">
                Financial management: accounts, budgets, and transactions
              </p>
            </div>
          </div>
        </div>
