...
export default function TradermapError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] px-4">
      <div className="max-w-md w-full bg-slate-800 rounded-xl border border-red-500/20 p-8 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white text-center mb-2">TraderMap Error</h2>
        <p className="text-slate-400 text-center text-sm mb-6">
          {error.message || 'An unexpected error occurred in TraderMap'}
        </p>
