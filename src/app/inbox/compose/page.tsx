  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <h1 className="display-font text-3xl font-semibold text-slate-50 mb-6 flex items-center gap-3">
        ...
        {mailboxes.length === 0 ? (
          <div className="text-center py-12 bg-slate-900/70 rounded-2xl shadow-[0_18px_40px_rgba(2,4,10,0.45)] border border-slate-700/60">
            ...
            <button
              ...
              className="px-4 py-2 bg-blue-600 text-slate-950 rounded-full hover:bg-blue-700"
            >
              Set up mailbox
            </button>
          </div>
          ...
          <div className="bg-slate-900/70 rounded-2xl shadow-[0_18px_40px_rgba(2,4,10,0.45)] border border-slate-700/60 p-6">
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-200 mb-1">From</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-slate-200 mb-1">To</label>
                <input
                  type="email"
                  value={toEmail}
              ...
              <div>
                <label className="block text-sm font-medium text-slate-200 mb-2">Attachments</label>
                <div className="flex items-center gap-2">
                  <label className="px-4 py-2 bg-slate-900/60 border border-slate-700/70 rounded-lg hover:bg-slate-800/70 cursor-pointer flex items-center gap-2 text-slate-200">
                ...
                {attachments.length > 0 && (
                  <div className="mt-2 space-y-1">
                    {attachments.map((file, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-2 bg-slate-900/70 border border-slate-700/60 rounded"
                      >
              ...
              <div className="flex gap-2 pt-4">
                <button
                  onClick={handleSend}
                  disabled={sending}
                  className="flex-1 px-6 py-3 bg-blue-600 text-slate-950 rounded-full hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-2 font-medium"
                >
